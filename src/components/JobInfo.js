...
function JobInfo({ type, created_at, company, location, title, logo, company_url, description, how_to_apply }) {
        ...
        <div className='jobinfo'>
                <div className={isLightTheme?"c_info":'c_info content-bg-dark'}>
                    ...
                    <div className="c_info_right">
                        <h1>{company}</h1>
                        <a className='apply-btn' href={company_url} target='_blank' rel="noopener noreferrer">Company Site</a>
                    </div>
                </div>
                <div className={isLightTheme?"desc":'desc content-bg-dark'} >
                    <div className="jinfo">
                        ...
                        <p >{title}</p>
                        <p id='location'><i className="fas fa-map-marker-alt"></i>{location}</p>
                    </div>
                    <div className="jdesc">
